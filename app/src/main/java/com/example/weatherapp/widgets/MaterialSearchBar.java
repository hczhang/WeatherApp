...
public class MaterialSearchBar extends FrameLayout implements View.OnClickListener,
    ...
    private void init(AttributeSet attrs) {
        inflate(getContext(), com.mancj.materialsearchbar.R.layout.searchbar, this);

        TypedArray array = getContext().obtainStyledAttributes(attrs, com.mancj.materialsearchbar.R.styleable.MaterialSearchBar);

        //Base Attributes
        speechMode = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_speechMode, false);
        maxSuggestionCount = array.getInt(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_maxSuggestionsCount, 3);
        navButtonEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_navIconEnabled, false);
        roundedSearchBarEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_roundedSearchBarEnabled, false);
        dividerColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_dividerColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarDividerColor));
        searchBarColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_searchBarColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarPrimaryColor));

        //Icon Related Attributes
        menuIconRes = array.getResourceId(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_menuIconDrawable, com.mancj.materialsearchbar.R.drawable.ic_dots_vertical_black_48dp);
        searchIconRes = array.getResourceId(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_searchIconDrawable, com.mancj.materialsearchbar.R.drawable.ic_magnify_black_48dp);
        speechIconRes = array.getResourceId(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_speechIconDrawable, com.mancj.materialsearchbar.R.drawable.ic_microphone_black_48dp);
        arrowIconRes = array.getResourceId(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_backIconDrawable, com.mancj.materialsearchbar.R.drawable.ic_arrow_left_black_48dp);
        clearIconRes = array.getResourceId(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_clearIconDrawable, com.mancj.materialsearchbar.R.drawable.ic_close_black_48dp);
        navIconTint = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_navIconTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarNavIconTintColor));
        menuIconTint = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_menuIconTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarMenuIconTintColor));
        searchIconTint = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_searchIconTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarSearchIconTintColor));
        arrowIconTint = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_backIconTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarBackIconTintColor));
        clearIconTint = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_clearIconTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarClearIconTintColor));
        navIconTintEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_navIconUseTint, true);
        menuIconTintEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_menuIconUseTint, true);
        searchIconTintEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_searchIconUseTint, true);
        arrowIconTintEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_backIconUseTint, true);
        clearIconTintEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_clearIconUseTint, true);
        borderlessRippleEnabled = array.getBoolean(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_borderlessRippleEnabled, false);

        //Text Related Attributes
        hintText = array.getString(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_hint);
        placeholderText = array.getString(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_placeholder);
        textColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_textColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarTextColor));
        hintColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_hintColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarHintColor));
        placeholderColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_placeholderColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarPlaceholderColor));
        textCursorColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_textCursorTint, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarCursorColor));
        highlightedTextColor = array.getColor(com.mancj.materialsearchbar.R.styleable.MaterialSearchBar_mt_highlightedTextColor, ContextCompat.getColor(getContext(), com.mancj.materialsearchbar.R.color.searchBarTextHighlightColor));
        ...
        RecyclerView recyclerView = findViewById(com.mancj.materialsearchbar.R.id.mt_recycler);
        ...
        //View References
        searchBarCardView = findViewById(com.mancj.materialsearchbar.R.id.mt_container);
        suggestionDivider = findViewById(com.mancj.materialsearchbar.R.id.mt_divider);
        menuIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_menu);
        clearIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_clear);
        searchIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_search);
        arrowIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_arrow);
        searchEdit = findViewById(com.mancj.materialsearchbar.R.id.mt_editText);
        placeHolder = findViewById(com.mancj.materialsearchbar.R.id.mt_placeholder);
        inputContainer = findViewById(com.mancj.materialsearchbar.R.id.inputContainer);
        navIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_nav);
        findViewById(com.mancj.materialsearchbar.R.id.mt_clear).setOnClickListener(this);
    ...
    private void inflateMenuRequest(int menuResource, int iconResId
        ...
        if (menuResource1 > 0) {
            ImageView menuIcon = findViewById(com.mancj.materialsearchbar.R.id.mt_menu);
            if (iconResId != -1) {
    ...
    private void setupRoundedSearchBarEnabled() {
        if (roundedSearchBarEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            searchBarCardView.setRadius(getResources().getDimension(com.mancj.materialsearchbar.R.dimen.corner_radius_rounded));
        } else {
            searchBarCardView.setRadius(getResources().getDimension(com.mancj.materialsearchbar.R.dimen.corner_radius_default));
        }
    }
    ...
    private void setupIcons() {
        //Drawables
        //Animated Nav Icon
        navIconResId = com.mancj.materialsearchbar.R.drawable.ic_menu_animated;
        this.navIcon.setImageResource(navIconResId);
        setNavButtonEnabled(navButtonEnabled);

        //Menu
        if (popupMenu == null) {
            findViewById(com.mancj.materialsearchbar.R.id.mt_menu).setVisibility(GONE);
        }
    ...
    public void closeSearch() {
        ...
        searchOpened = false;
        Animation out = AnimationUtils.loadAnimation(getContext(), com.mancj.materialsearchbar.R.anim.fade_out);
        Animation in = AnimationUtils.loadAnimation(getContext(), com.mancj.materialsearchbar.R.anim.fade_in_right);
    ...
    public void openSearch() {
        ...
        searchOpened = true;
        Animation left_in = AnimationUtils.loadAnimation(getContext(), com.mancj.materialsearchbar.R.anim.fade_in_left);
        Animation left_out = AnimationUtils.loadAnimation(getContext(), com.mancj.materialsearchbar.R.anim.fade_out_left);
    ...
    private void animateNavIcon(boolean menuState) {
        if (menuState) {
            this.navIcon.setImageResource(com.mancj.materialsearchbar.R.drawable.ic_menu_animated);
        } else {
            this.navIcon.setImageResource(com.mancj.materialsearchbar.R.drawable.ic_back_animated);
        }
    ...
    private void animateSuggestions(int from, int to) {
        ...
        final RecyclerView suggestionsList = findViewById(com.mancj.materialsearchbar.R.id.mt_recycler);
        final ViewGroup.LayoutParams lp = suggestionsList.getLayoutParams();
        if (to == 0 && lp.height == 0)
            return;
        findViewById(com.mancj.materialsearchbar.R.id.mt_divider).setVisibility(to > 0 ? View.VISIBLE : View.GONE);
    ...
    public void setCardViewElevation(int elevation) {
        CardView cardView = findViewById(com.mancj.materialsearchbar.R.id.mt_container);
    ...
    public void onClick(View v) {
        ...
        } else if (id == com.mancj.materialsearchbar.R.id.mt_arrow) {
            closeSearch();
        } else if (id == com.mancj.materialsearchbar.R.id.mt_search) {
            if (listenerExists())
                onSearchActionListener.onButtonClicked(BUTTON_SPEECH);
        } else if (id == com.mancj.materialsearchbar.R.id.mt_clear) {
            searchEdit.setText("");
        } else if (id == com.mancj.materialsearchbar.R.id.mt_menu) {
            popupMenu.show();
        } else if (id == com.mancj.materialsearchbar.R.id.mt_nav) {
